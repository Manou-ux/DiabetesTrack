              ...
              child: Column(
                children: [
                  ...
                  ListTile(
                    ...
                    title: Text(
                      // HH:mm (en majuscules) garantit le format 24h dans l'affichage texte
                    ...
                    onTap: () async {
                      ...
                      if (d != null) {
                        // AJOUT : builder configuré pour forcer le format 24 heures à l'écran
                        ...
                        if (t != null) {
                          setState(() { 
                            _selectedDateTime = DateTime(d.year, d.month, d.day, t.hour, t.minute); 
                          });
                        }
                      }
                    },
